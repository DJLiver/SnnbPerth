...
public partial class Monitor
{
    ...
    private async void RecData(RtStatus rtStatus)
    {
        ...
        //NPDGPrimary.MonitorTable = rtStatus.GetRtMonitor("Primary");
        //NPDGSecondary.MonitorTable = rtStatus.GetRtMonitor("Secondary");
        ...
        //if (NPDGPrimary.MonitorTable != null)
        //{
        //    (int index, string txt) p = GetPathStatus(NPDGPrimary.MonitorTable);
        //    NPDGPrimary.PathStylesIndex = p.index;
        //    NPDGPrimary.PathText = p.txt;

        //    NPDGPrimary.StatusStylesIndex = GetSummaryStatus(NPDGPrimary.MonitorTable);
        //}
        //if (NPDGSecondary.MonitorTable != null)
        //{
        //    (int index, string txt) p = GetPathStatus(NPDGSecondary.MonitorTable);
        //    NPDGSecondary.PathStylesIndex = p.index;
        //    NPDGSecondary.PathText = p.txt;

        //    NPDGSecondary.StatusStylesIndex = GetSummaryStatus(NPDGSecondary.MonitorTable);
        //}
